[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(LYSApp.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(LYSApp.Web.App_Start.NinjectWebCommon), "Stop")]

namespace LYSApp.Web.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
           ...
           // kernel.Bind<ISMSNotificationManagement>().To<SMSNotificationManagement>();
        }        
    }
}
